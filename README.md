...
_See code: [src/commands/compile.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/compile.ts)_
...
_See code: [src/commands/config/change.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/config/change.ts)_
...
_See code: [src/commands/config/show.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/config/show.ts)_
...
_See code: [src/commands/init.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/init.ts)_
...
_See code: [src/commands/repl.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/repl.ts)_
...
_See code: [src/commands/run.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/run.ts)_
...
_See code: [src/commands/test.ts](https://github.com/wavesplatform/surfboard/blob/v2.2.4/src/commands/test.ts)_
<!-- commandsstop -->
